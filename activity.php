...
<head>
  ...
  <title>Futsal Club Information System</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
    Futsal Club Information System
  </nav>
...
<h5>| <a href="index.php">Home </a>| <a href="club.php">Club </a>| <a href="membership.php">Membership</a> | <a href="activity.php">Activities </a> | <a href="contact.php">Contact Us</a> | </h5></p>
  ...
  <div class="container">
    ...
    ?>
	<p align="center"><h3>Activities form for Futsal Club Information System (FCIS)</h3></p>
